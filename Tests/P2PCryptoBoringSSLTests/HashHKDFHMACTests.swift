...
// SHA-256/384, HKDF (RFC 5869), and HMAC (RFC 4231/2202) KATs for the BoringSSL
// provider.
import Testing
...
@Suite("BoringSSL HKDF KAT")
struct BoringSSLHKDFTests {
...
@Suite("BoringSSL HMAC KAT")
struct BoringSSLHMACTests {
