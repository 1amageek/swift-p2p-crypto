...
// sign/verify KATs for the Embedded provider.
import Testing
import P2PCoreCrypto
@testable import P2PCryptoEmbedded

@Suite("Embedded X25519 KAT")
struct EmbeddedX25519Tests {
...
@Suite("Embedded EC ECDH KAT")
struct EmbeddedECDHTests {
...
@Suite("Embedded Ed25519 KAT")
struct EmbeddedEd25519Tests {
...
@Suite("Embedded ECDSA KAT")
struct EmbeddedECDSATests {
