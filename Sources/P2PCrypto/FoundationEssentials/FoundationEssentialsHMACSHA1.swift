// FoundationEssentialsHMACSHA1.swift
...
public struct FoundationEssentialsHMACSHA1: P2PCoreCrypto.MessageAuthenticationCode {
    public static let macLength = 20

    private var hasher: HMAC<Insecure.SHA1>

    public init(key: Span<UInt8>) {
        self.hasher = HMAC<Insecure.SHA1>(key: SymmetricKey(data: key.toArray()))
    }
