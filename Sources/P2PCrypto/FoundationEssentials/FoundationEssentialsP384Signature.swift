// FoundationEssentialsP384Signature.swift
...
public enum FoundationEssentialsP384Signature: SignatureScheme {
    ...
    public static func isValid(
        ...
        do {
            let sig = try P384.Signing.ECDSASignature(rawRepresentation: signature.toArray())
